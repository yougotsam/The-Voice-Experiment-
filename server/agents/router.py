...
ROUTER_PROMPT = (
    ...
    "- creative: Drafting content, blog posts, social media, email copy, ad scripts\n"
...
_TASK_KEYWORDS = re.compile(
    ...
    r"event|draft|blog|post|caption|content|write|compose|search|find|create|look\s*up)\b",
    re.IGNORECASE,
)
